...
nodo *buscarMayor(nodo *lista);

int main() {
    nodo *lista = NULL;

    int n, op, op1, op2, op3, op4, posicion;
...
nodo *buscarMayor(nodo *lista){
    nodo *temporal=lista,*segundoT=lista,*mayor=lista;
    int a;
    for(temporal;temporal->sig==NULL;temporal=temporal->sig){

        for(segundoT->sig;segundoT->sig==NULL;segundoT=segundoT->sig){

            //Aqui solo estoy probando ignoralo 
